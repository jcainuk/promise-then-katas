...
const returnTen = () => new Promise((resolve, reject) => {
  resolve(10);
});
...
const returnString = () => new Promise((resolve, reject) => {
  resolve('string');
});
...
const returnBob = () => new Promise((resolve, reject) => {
  resolve({ name: 'Bob' });
});
...
const returnList = () => new Promise((resolve, reject) => {
...
const anError = () => new Promise((resolve, reject) => {
...
const theNumberOfTheBeast = () => new Promise((resolve, reject) => {
  reject(666);
});
...
const internalServerError = () => new Promise((resolve, reject) => {
  reject({ error: 500 });
});
